...
public class MainActivity extends AppCompatActivity {
    ...
    String EmailHolder, PasswordHolder,radiostring;
        ...
        LogInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(EmailHolder.equals("admin")&&PasswordHolder.equals("admin"))
                {
                    ...
                    Intent intent = new Intent(MainActivity.this, adminfome.class);
        ...
        if(EditTextEmptyHolder) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (cursor.isFirst()) {
                    ...
                    usertype = cursor.getString(cursor.getColumnIndex(SQLiteHelper.Table_Column_5_usertyp));
    ...
    public void CheckFinalResult() {
        ...
        if (TempPassword.equalsIgnoreCase(PasswordHolder)) {
            ...
            if(usertype.equals("Police")) {
                ...
                // Going to Dashboard activity after login success message.
                Intent intent = new Intent(MainActivity.this, police_alert.class);

                // Sending Email to Dashboard Activity using intent.
                intent.putExtra("uname", EmailHolder);
                startActivity(intent);
            }
